...
parser.add_argument('--epochSize', type=int, default=300, help='number of batches as one epoch (for validating once)')
...
parser.add_argument('--kernel_size', type=int, default=3, help='size of one kernel')
...
net = ZebraSRNet(nFeat=args.nFeat, kernel_size=args.kernel_size, nResBlock=args.nResBlock)
...
def checkpoint(epoch): 
    save_name = 'net_F{}B{}_epoch_{}.pth'.format(args.nFeat, args.nResBlock, epoch)
